...
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder> {
    ...
    public DrawerAdapter(String[] menuString, int[] menuIcons, int headerImage, Integer[] dividersPosition) {
    ...
    public int getItemViewType(int position) {
        ...
        if (Arrays.asList(dividersPosition).contains(Integer.valueOf(position))) {
            return TYPE_DIVIDER;
        }
        return TYPE_ITEM;
    }
